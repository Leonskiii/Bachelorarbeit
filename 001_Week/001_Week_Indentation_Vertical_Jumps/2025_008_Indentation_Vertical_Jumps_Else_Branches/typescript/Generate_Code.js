...
export class Return extends Term {
    constructor(return_value) {
        ...
        this.fake_method = next_fake_method();
    }
...
export class Nested_Ifs extends Term {
    constructor() {
        super();
        this.else_fake_method = next_fake_method();
    }
    print_into(array, indentation_depth, indentation_length) {
        ...
        array.push(indent + "} else {\n");
        array.push(indent1 + this.else_fake_method + "\n");
        array.push(indent + "}");
