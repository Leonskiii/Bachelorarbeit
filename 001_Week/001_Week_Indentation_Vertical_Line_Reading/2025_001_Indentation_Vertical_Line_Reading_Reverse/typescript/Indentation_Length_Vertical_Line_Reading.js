...
export function set_if_conditions_on_nous_each_starting_with_different_letter(if_statement) {
    ...
    while (if_statement instanceof Nested_Ifs) {
        ...
        if_statement.condition_string = next_words + "_" + counter;
...
let experiment_configuration_function = (writer) => {
    return {
        ...
        task_configuration: (t) => {
            ...
            target_condition_string = target_condition_string.substring(0, target_condition_string.indexOf("_"));
            ...
            t.do_print_after_task_information = () => {
                writer.clear_stage();
                writer.print_error_string_on_stage(writer.convert_string_to_html_string("Press [Enter] to go on. "));
            };
        }
    };
};
