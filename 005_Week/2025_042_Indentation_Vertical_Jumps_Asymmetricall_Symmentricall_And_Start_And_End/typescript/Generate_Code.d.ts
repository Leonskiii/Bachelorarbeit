export type Condition_Layout = "Symmetric" | "Asymmetric";
...
export declare function generate_If_Statement(indentation_depth: any, nesting_depth: any, indentation_length: any, layout: Condition_Layout, target_level?: number): Nested_Ifs;
