export declare abstract class Term {
    ...
    print_string_continuation(): string;
}
export declare function set_if_conditions_random_length(if_statement: Term): void;
...
export declare function set_if_conditions_by_length(if_statement: Term, condition_length: number): void;
