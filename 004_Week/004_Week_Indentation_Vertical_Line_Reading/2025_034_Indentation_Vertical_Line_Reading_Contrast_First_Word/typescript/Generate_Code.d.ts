...
export declare function generate_If_Statement(indentation_depth: number, nesting_depth: number, chain_length: number, target_level: number, contrast: boolean): Nested_Ifs;
