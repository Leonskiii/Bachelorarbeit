...
export declare class Nested_Ifs extends Term {
    ...
    print_into_right_to_left(array: string[], depth: number, max_depth: number, length: number): void;
...
export declare function set_if_conditions_on_nouns_each_starting_with_different_letter(if_statement: Term): void;
