...
let experiment_configuration_function = (writer: Experiment_Output_Writer) => {
    return {
        ...
        task_configuration: (t: Task) => {
            ...
            html_string = html_string.replace("}&nbsp;" + target_return_value + "<br/>", "<span style=\"background-color:red\">}</span>&nbsp;<span style=\"background-color:red\">" + target_return_value + "</span><br/>");
            ...
            t.do_print_after_task_information = () => {
                ...
                writer.print_error_string_on_stage(writer.convert_string_to_html_string(
                    "The corresponding if-condition was: " + target_condition_string + "\n\n" +
