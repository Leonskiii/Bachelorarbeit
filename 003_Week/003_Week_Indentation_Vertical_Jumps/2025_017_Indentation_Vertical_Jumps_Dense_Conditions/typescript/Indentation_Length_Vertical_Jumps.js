...
let experiment_configuration_function = (writer) => {
    return {
        ...
        task_configuration: (t) => {
            ...
            let if_statement = generate_If_Statement(length, nesting_depth, length);
            ...
            let target_noun = if_statement.target_noun(target_expression_number);
            html_string = html_string.replace(target_noun, "<span style=\"background-color:red\">" + target_noun + "</span>");
