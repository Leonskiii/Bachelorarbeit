...
export function generate_if_tree(nesting_depth, seed) {
    ...
    function answer_for_level(level) {
        let node = current;
...
export function tree_to_html(tree, marked_level, length, density, seed) {
