...
let experiment_configuration_function = (writer) => {
    return {
        ...
        layout: [
            ...
            { variable: "Empty_Lines", treatments: ["0", "1", "2", "3"] },
        ...
        task_configuration: (t) => {
            ...
            let empty_lines = parseInt(t.treatment_value("Empty_Lines"));
            let html_string = convert_string_to_html_string(if_statement.print_string(length, empty_lines));
            ...
            t.do_print_task = () => {
                ...
                const randomTop = 5 + Math.floor(Math.random() * 20);
